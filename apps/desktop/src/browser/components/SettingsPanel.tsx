...
type SettingsPanelProps = {
  ...
  workspaceActionState?: "creating" | "opening" | null;
      ...
      <div className="flex flex-1 flex-col px-4 pb-4">
        ...
        <div className="grid grid-cols-[96px_minmax(0,1fr)] items-center gap-x-3 gap-y-3">
          ...
          <div className="flex items-center gap-2.5">
            <Checkbox
              ...
              id="settings-night-mode"
              onCheckedChange={(checked) => onNightModeChange(checked === true)}
            />
            <span className="text-[0.8125rem] font-medium">Night mode</span>
          </div>
        ...
        <div className="mt-auto pt-4">
          <Button asChild className="w-full" size="sm" variant="secondary">
            <a href="mailto:feedback@linea.app?subject=Rekna%20Feedback">
